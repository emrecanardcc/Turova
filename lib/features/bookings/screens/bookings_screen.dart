        ...
        child: Column(
          ...
          children: [
              ...
              children: [
                ...
                Container(
                  decoration: BoxDecoration(
                    ...
                    boxShadow: [
                      BoxShadow(
                        color: const Color(0xFF1CA9C9).withValues(alpha: 0.3),
                        blurRadius: 12,
                  ...
                  child: ElevatedButton.icon(
                    ...
                    onPressed: () {
                      ...
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(
                          content: Text('Yeni Rezervasyon Formu eklenecek.'),
                        ),
                      );
                    },
                    icon: const Icon(
            ...
            bookingsAsync.when(
              ...
              data: (bookings) =>
                  _buildRecentReservationsTable(context, bookings),
            ),
          ],
        ),
      ),
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: isToday
              ...
              : (isFaded ? Colors.grey.shade50 : Colors.white),
          border: Border.all(
            color: isToday
          ...
          children: [
            Text(
              ...
              style: TextStyle(
                ...
                color: isToday
                    ? Theme.of(context).colorScheme.primary
                    : (isFaded ? Colors.grey : Colors.black87),
              ),
            ),
            ...
            Row(
              ...
              children: [
                ...
                const Padding(
                  ...
                  child: Text('Dolu', style: TextStyle(color: Colors.grey)),
                ),
              ],
            ),
            const SizedBox(height: 16),
        ...
        children: [
          ...
          if (bookings.isEmpty)
            const Padding(
              ...
              child: Center(
                child: Text(
                  'Henüz sisteme girilmiş bir rezervasyon kaydı bulunmuyor.',
            ...
            ...bookings.map((booking) {
              ...
              final String id = booking['id']
                  ...
                  .substring(0, 5)
                  .toUpperCase();
              final String customerName = booking['customers'] != null
                  ? booking['customers']['full_name']
                  : 'Bilinmeyen Müşteri';
              final String tourName = booking['tours'] != null
                  ? booking['tours']['title']
                  : 'Bilinmeyen Tur';
              final String status = booking['status'] ?? 'Bekliyor';
              final String payment =
                  booking['payment_status'] ?? 'Ödeme Bekliyor';
