    ...
    return Scaffold(
      body: financeAsync.when(
        ...
        error: (err, stack) => Center(
          child: Text('Finans verileri yüklenirken hata oluştu: $err'),
        ),
        data: (financeData) {
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Row(
                        children: [
                          Icon(
                            isUp ? Icons.trending_up : Icons.drag_handle,
              ...
              child: Center(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Grafik entegrasyonu bekleniyor...',
        ...
        children: [
          ...
          if (invoices.isEmpty)
            const Padding(
              ...
              child: Center(
                child: Text(
                  'Henüz sistemde finansal bir kayıt bulunmuyor.',
            ...
            ...invoices.map((inv) {
              ...
              if (inv['status'] == 'İptal' || inv['status'] == 'İade')
